...
# Load the library
source ./controller/Keyboards/cmake.bash --output-path ./build/ --cmakelists-path ../controller/

mv ./build/kiibohd.dfu.bin ./bepo-left.dfu.bin
...
mv ./build/kiibohd.dfu.bin ./bepo-right.dfu.bin
